...
output			= $(simulation_path)/sim/C26-5d_4_2_3_0_logfiles/log.out.$(Process)

# the path to the error output -> console output is flushed to this file if any errors occur
error			= $(simulation_path)/sim/C26-5d_4_2_3_0_logfiles/log.err.$(Process)
...
#/usr/bin/time -v ./ColliRotate C26-5d_4_2_3_0.mac
request_memory  = 1000 MB

# pass down a macrofile to your simulation
arguments   = $(simulation_path)/C26-5d_4_2_3_0.mac
