...
output			= $(simulation_path)/sim/C26-5d_4_1_4_0_logfiles/log.out.$(Process)

# the path to the error output -> console output is flushed to this file if any errors occur
error			= $(simulation_path)/sim/C26-5d_4_1_4_0_logfiles/log.err.$(Process)
...
arguments   = $(simulation_path)/C26-5d_4_1_4_0.mac
